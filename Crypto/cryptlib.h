...
public:
	...
	//throw NotImplemented("Clone() is not implemented yet.");
	}	// TODO: make this =0
};
...
public:
	...
	/// \return default length of IVs accepted by this o/// bject, in bytes
...
public:
	...
	/// \param bt the destination BufferedTrans/// formation
	/// \throw NotImplemented
	/// \details Save() write/// s the material to a BufferedTransformation.
	...
	/// \details If a///  derived class does not override Save(), then	he base class throws
	///  NotImplemented().
	...
	///  material is a key th/// at was generat/// ed outside the library, then the following
	///  usually applies:
	///   <ul>
	...
	/// \param prec/// omputationStorage th/// e suggested number of objects for the precompute table
	/// \throw NotImplemented
 ...
 // throw NotImplemented("CryptoMaterial: this object does not support precomputation");
	...
	/// \details D/// oQuickSanityCheck() is for internal library use, and it should not be called by library users.
